...
public class Base58Test extends TestCase {
    ...
    public void testDecode() throws Exception {
        ...
        Base58.decodeChecked("4stwEBjT6FYyVV", new Sha256ChecksumProvider());

        // Checksum should fail.
        try {
            Base58.decodeChecked("4stwEBjT6FYyVW", new Sha256ChecksumProvider());
            fail();
        } catch (AddressFormatException e) {
            // expected
        }
        ...
        // Input is too short.
        try {
            Base58.decodeChecked("4s", new Sha256ChecksumProvider());
            fail();
        } catch (AddressFormatException e) {
            // expected
        }
        ...
        // first byte is not zero, so BigInteger
        // sign extends. Fix for a bug that stopped us parsing keys exported
        // using sipas patch.
        Base58.decodeChecked("93VYUMzRG9DdbRP72uQXjaWibbQwygnvaCu9DumcqDjGybD864T", new Sha256ChecksumProvider());
    }
